            ...
            <div class="w-1/3 p-5 flex flex-col gap-6">
                ...
                <div class="bg-stone-100 p-5 rounded-xl flex flex-col gap-3">
                    <div class="flex gap-x-2 items-center">
                        ...
                        <h4 class="font-bold">نوع غذا: </h4>
                        <span class="text-gray-700">{{ $restaurant->food_type }}</span>
                    </div>
                    <div class="flex gap-x-2 items-center">
                ...
                <div class="flex gap-x-5 items-center">
                    ...
                    <a href="{{ route('restaurants.index') }}" class="flex items-center gap-3 group border-2 border-red-700 rounded-full text-red-800 py-2 px-5 text-sm font-medium hover:border-green-700 hover:text-green-700">
